...
def upgrade() -> None:
    ...
    # ── productcategory ───────────────────────────────────────────────────
    op.execute("ALTER TABLE products ALTER COLUMN category TYPE TEXT USING category::TEXT")
    ...
    # ── productunit ───────────────────────────────────────────────────────
    op.execute("ALTER TABLE products ALTER COLUMN unit DROP DEFAULT")
    op.execute("ALTER TABLE products ALTER COLUMN unit TYPE TEXT USING unit::TEXT")
    ...
    op.execute("DROP TYPE IF EXISTS productunit CASCADE")
    op.execute(
    ...
    op.execute("ALTER TABLE trips ALTER COLUMN status TYPE TEXT USING status::TEXT")
    ...
    # ── waypointstatus ────────────────────────────────────────────────────
    op.execute("ALTER TABLE waypoints ALTER COLUMN status DROP DEFAULT")
    op.execute("ALTER TABLE waypoints ALTER COLUMN status TYPE TEXT USING status::TEXT")
    ...
    op.execute("DROP TYPE IF EXISTS waypointstatus CASCADE")
    op.execute(
    ...
    # ── waypointtype ──────────────────────────────────────────────────────
    op.execute("ALTER TABLE waypoints ALTER COLUMN waypoint_type TYPE TEXT USING waypoint_type::TEXT")
    ...
    op.execute("DROP TYPE IF EXISTS waypointtype CASCADE")
    op.execute(
...
def downgrade() -> None:
    ...
    op.execute("DROP TYPE IF EXISTS waypointtype CASCADE")
    op.execute("CREATE TYPE waypointtype AS ENUM ('pickup', 'dropoff', 'depot')")
    op.execute(
        "ALTER TABLE waypoints ALTER COLUMN waypoint_type TYPE waypointtype "
        "USING waypoint_type::waypointtype"
    )
    ...
    op.execute("DROP TYPE IF EXISTS waypointstatus CASCADE")
    op.execute("CREATE TYPE waypointstatus AS ENUM ('pending', 'arrived', 'completed', 'skipped')")
    op.execute(
        "ALTER TABLE waypoints ALTER COLUMN status TYPE waypointstatus "
        "USING status::waypointstatus"
    )
    op.execute("ALTER TABLE waypoints ALTER COLUMN status SET DEFAULT 'pending'::waypointstatus")
    ...
    op.execute("DROP TYPE IF EXISTS tripstatus CASCADE")
    op.execute("CREATE TYPE tripstatus AS ENUM ('planned', 'in_progress', 'completed', 'cancelled')")
    op.execute(
        "ALTER TABLE trips ALTER COLUMN status TYPE tripstatus USING status::tripstatus"
    )
    op.execute("ALTER TABLE trips ALTER COLUMN status SET DEFAULT 'planned'::tripstatus")
    ...
    op.execute("ALTER TABLE orders ALTER COLUMN payment_status SET DEFAULT 'unpaid'::paymentstatus")
    ...
    op.execute("DROP TYPE IF EXISTS productunit CASCADE")
    op.execute("CREATE TYPE productunit AS ENUM ('kg', 'ton', 'piece', 'liter', 'box')")
    op.execute(
        "ALTER TABLE products ALTER COLUMN unit TYPE productunit USING unit::productunit"
    )
    op.execute("ALTER TABLE products ALTER COLUMN unit SET DEFAULT 'kg'::productunit")
    ...
    op.execute("DROP TYPE IF EXISTS userrole CASCADE")
    op.execute(
        "CREATE TYPE userrole AS ENUM ('customer', 'farmer', 'logist', 'driver', 'admin')"
    )
