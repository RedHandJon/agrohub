...
from app.schemas.auth import RegisterRequest, LoginRequest, TokenPair, RefreshRequest, AuthResponse
...
async def logout():
    ...
    # For server-side invalidation, a token blocklist (Redis) would be added here.
    return None
